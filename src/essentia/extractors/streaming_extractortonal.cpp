...
void TuningSystemFeatures(Pool &pool, const string &nspace)
{
    ...
    cout << "Tuning system features" << endl;
    ...
    shared_ptr<standard::Algorithm> keyDetect(factory.create("Key", "profileType", "diatonic"));
    ...
    shared_ptr<standard::Algorithm> highres(factory.create("HighResolutionFeatures"));
