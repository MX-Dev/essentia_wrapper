...
void SFXPitch(Pool &pool, const string &nspace)
{
    ...
    shared_ptr<standard::Algorithm> maxtt(standard::AlgorithmFactory::create("MaxToTotal"));
    Real maxToTotal;
    ...
    shared_ptr<standard::Algorithm> mintt(standard::AlgorithmFactory::create("MinToTotal"));
    Real minToTotal;
    ...
    shared_ptr<standard::Algorithm> pc(standard::AlgorithmFactory::create("Centroid"));
    Real centroid;
    ...
    shared_ptr<standard::Algorithm> amt(standard::AlgorithmFactory::create("AfterMaxToBeforeMaxEnergyRatio"));
    Real ratio;
