...
#ifndef STREAM_EQLOUD_LOADER_H
#define STREAM_EQLOUD_LOADER_H
...
public:
    StreamEqloudLoader(const callbacks *cb);
    virtual ~StreamEqloudLoader() = default;
